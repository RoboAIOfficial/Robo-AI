        ...
        >
          ...
          {activeTab === 'story' && (
            <div className="relative">
              ...
              <div 
                className="max-w-none bg-gradient-to-br from-white to-blue-50/30 rounded-2xl p-8 shadow-inner relative overflow-hidden prose prose-blue"
          ...
          {activeTab === 'gallery' && (
            <div className="grid grid-cols-2 gap-6">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-blue-100 to-purple-100 p-4 flex items-center justify-center relative overflow-hidden group hover:shadow-xl transition-all">
                ...
                <img src={robot.avatar} alt={robot.name} className="w-3/4 h-3/4 object-contain" />
              </div>
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-purple-100 to-pink-100 p-4 flex items-center justify-center relative overflow-hidden group hover:shadow-xl transition-all">
                ...
                <img src={robot.avatar} alt={robot.name} className="w-3/4 h-3/4 object-contain transform -scale-x-100" />
              </div>
            </div>
          )}
